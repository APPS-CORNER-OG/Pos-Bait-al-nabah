...
<script type="text/javascript">
  if (screen.width <= 2000) {
      ...
      document.write('<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden; width: 100%; height: 100%;">');
  }
</script> 
<div class="wrapper">
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?php $var = 1; while($var <= 12){ echo $array_of_data[$var++];  echo ",";}  ?>],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
