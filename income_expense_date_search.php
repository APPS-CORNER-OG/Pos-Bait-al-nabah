...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Select Date to see Income and Expense Final Report
      </h1>
      <h1>
    ...
    <section class="content">
      <div class="row">
        <!-- left column -->
        <form role="form" id="form" action="reporting_by_date.php" method="POST" enctype="multipart/form-data">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-danger pull-right"><i class="fa fa-plus-circle"></i> Search</button>
                      </div>
